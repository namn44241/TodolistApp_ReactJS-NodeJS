...
function TaskModal({ open, handleClose, taskData, setTaskData, handleSubmit, user, users, isGuestMode }) {
      ...
      <div className="modal-overlay">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            {/* Thêm phần subtasks cho guest mode */}
                  ...
                  <tbody>
                    {subtasks.map((subtask, index) => (
                      <tr key={subtask.id}>
                        ...
                        <td>
                          {isGuestMode ? 'Khách' : (subtask.created_by_name || user?.username)} 
                        </td>
                        <td>
                          {(user?.role === 'admin' || user?.role === 'manager') ? (
                            <select
